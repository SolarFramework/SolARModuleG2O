        ...
        stage("Pre-Release") {
            ...
            steps {                
                withCredentials([string(credentialsId: 'github-token', variable: 'token')]) {
                    preRelease("SolARModuleG2O","SolARModuleG2O/${version}/linux","SolARModuleG2O Version ${version} for Linux","${WORKSPACE}/artifactory/x86_64_shared_release/SolARModuleG2O_${version}_x86_64_shared_release.zip ${WORKSPACE}/artifactory/x86_64_shared_debug/SolARModuleG2O_${version}_x86_64_shared_debug.zip",token);                    
                }
            }   
        }         
